...
public class AnakinSkywalker extends InventoryGUI {
    ...
    protected Inventory createInventory() {
        return Bukkit.createInventory(null, 6 * 9, MandoMCRemade.str("&9&lAnakin Skywalker's Lightsaber"));
    }
    ...
    public void decorate(Player player) {
        ...
        this.addButton(21, this.createNullButton(CustomItems.kyber("BlueKyber")));
        this.addButton(24, this.createNullButton(CustomItems.lightSaber("AnakinSkywalker")));
        this.addButton(30, this.createNullButton(CustomItems.hilt("AnakinSkywalker")));
