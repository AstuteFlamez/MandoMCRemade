...
public class AnakinSkywalker extends InventoryGUI {
    ...
    protected Inventory createInventory() {
        return Bukkit.createInventory(null, 6 * 9, str("&9&lAnakin Skywalker's Hilt"));
    }
    ...
    public void decorate(Player player) {
        ...
        this.addButton(12, this.createNullButton(new ItemStack(Material.STONE_BUTTON)));
        ...
        this.addButton(24, this.createNullButton(CustomItems.hilt("AnakinSkywalker")));
        ...
        this.addButton(31, this.createNullButton(new ItemStack(Material.GOLD_BLOCK)));
